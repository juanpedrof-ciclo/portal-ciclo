...
import type { Unidad, VistaFacturaSaldo } from "@/lib/financiero/types";
import { formatCOP, formatFechaCorta } from "@/lib/financiero/types";

export const metadata = { title: "Cuentas por pagar · Módulo Financiero" };
...
export default async function CuentasPorPagarPage({
  ...
  const RUTA = `/${unidad}/financiero/resultados/cuentas-por-pagar`;
