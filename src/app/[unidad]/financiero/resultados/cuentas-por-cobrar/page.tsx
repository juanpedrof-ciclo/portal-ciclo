...
import type { Unidad, VistaIngresoSaldo } from "@/lib/financiero/types";
import { CANAL_LABELS, formatCOP, formatFechaCorta } from "@/lib/financiero/types";

export const metadata = { title: "Cuentas por cobrar · Módulo Financiero" };
...
export default async function CuentasPorCobrarPage({
  ...
  const RUTA = `/${unidad}/financiero/resultados/cuentas-por-cobrar`;
