...
import { conciliarMovimiento, crearMovimiento } from "./actions";
...
export const metadata = {
  title: "Conciliación bancaria · Módulo Financiero",
};
...
export default async function ConciliacionPage({
  ...
  const RUTA = `/${unidad}/financiero/resultados/conciliacion`;
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
            ...
            <a href={`/${unidad}/financiero/resultados/banco-caja`} className="underline">
              Banco y caja
            </a>
            .
          </p>
      ...
      <MovimientoForm action={crearMovimiento.bind(null, unidad)} />
                  ...
                  <tr key={m.id}>
                    ...
                    <td className="px-4 py-3">
                      {m.conciliado && m.pagos ? (
                        <form
                          action={conciliarMovimiento.bind(null, unidad)}
