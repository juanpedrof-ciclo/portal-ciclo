...
import { anularPedido, anularPedidosLote, procesarCargaVentas } from "./actions";
...
export const metadata = { title: "Ventas · Módulo Financiero" };
...
export default async function VentasPage({
  ...
  const RUTA = `/${unidad}/financiero/ventas`;
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <CargaForm unidad={unidad} action={procesarCargaVentas.bind(null, unidad)} />
      ...
      <SeleccionProvider idsVisibles={idsVisibles}>
        <AnularSeleccionadosBar
          ...
          action={anularPedidosLote.bind(null, unidad)}
        />
                ...
                pedidos.map((p) => (
                  <tr key={p.id}>
                    ...
                    <td className="px-4 py-3">
                      <AnularForm
                        id={p.id}
                        action={anularPedido.bind(null, unidad)}
