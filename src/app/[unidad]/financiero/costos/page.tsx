...
import { anularFactura, anularFacturasLote, crearFactura } from "./actions";
...
export default async function CostosPage({
  ...
  const RUTA = `/${unidad}/financiero/costos`;
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <FacturaForm
        unidad={unidad}
        action={crearFactura.bind(null, unidad)}
      ...
      <SeleccionProvider idsVisibles={idsVisibles}>
        <AnularSeleccionadosBar
          ...
          action={anularFacturasLote.bind(null, unidad)}
        />
                ...
                facturas.map((f) => (
                  <tr key={f.id}>
                    ...
                    <td className="px-4 py-3">
                      <AnularForm
                        id={f.id}
                        action={anularFactura.bind(null, unidad)}
