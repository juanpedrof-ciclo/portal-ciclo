...
import { anularIngreso, anularIngresosLote, crearIngreso } from "./actions";
...
import type { IngresoSemanal, Unidad } from "@/lib/financiero/types";
import {
  CANAL_LABELS,
...
export const metadata = { title: "Ingresos · Módulo Financiero" };
...
export default async function IngresosPage({
  ...
  const RUTA = `/${unidad}/financiero/ingresos`;
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <IngresoForm unidad={unidad} action={crearIngreso.bind(null, unidad)} />
      ...
      <SeleccionProvider idsVisibles={idsVisibles}>
        <AnularSeleccionadosBar
          ...
          action={anularIngresosLote.bind(null, unidad)}
        />
                  ...
                  ingresos.map((ingreso) => (
                    <tr key={ingreso.id}>
                      ...
                      <td className="px-4 py-3">
                        <AnularForm
                          id={ingreso.id}
                          action={anularIngreso.bind(null, unidad)}
