...
export const metadata = { title: "Módulo Financiero · Ciclo Market · Portal Ciclo" };

const ACCESOS = [
  {
    href: "/market/financiero/ingresos",
    label: "Registrar ingresos",
    description: "Total de venta de la semana.",
    icon: TrendingUp,
  },
  {
    href: "/market/financiero/costos",
    label: "Registrar factura",
    description: "Costos y gastos por proveedor.",
    icon: Receipt,
  },
  {
    href: "/market/financiero/pagos",
    label: "Registrar pago",
    description: "Cruces contra facturas o ventas.",
    icon: Banknote,
  },
  {
    href: "/market/financiero/resultados/conciliacion",
...
export default async function FinancieroDashboardPage() {
  ...
  const pg = await calcularPG(supabase, desde, hasta);
    ...
    <div className="flex flex-col gap-8">
      <section>
        <div className="flex items-center justify-between">
          ...
          <Link
            href="/market/financiero/resultados/pg"
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            href="/market/financiero/resultados/cuentas-por-pagar"
          ...
          <Link
            href="/market/financiero/resultados/cuentas-por-cobrar"
            className="inline-flex items-center gap-2 rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm font-medium text-zinc-700 transition hover:border-amber-300 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-200"
          >
