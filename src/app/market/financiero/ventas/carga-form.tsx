...
import { procesarCargaVentas, type EstadoFormularioCarga } from "./actions";
...
function CargaFormCampos({
  ...
  async function onArchivoChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const res = await fetch("/market/financiero/ventas/detectar-columnas", {
        method: "POST",
        body: fd,
      });
